...
namespace TC57CIM.IEC61970.Base.DiagramLayout {
	...
	public class Diagram : IdentifiedObject {
		...
		/// </summary>
		public TC57CIM.IEC61970.Base.Domain.Float x1InitialView;
		/// <summary>
		/// X coordinate of the second corner of the initial view.
		/// </summary>
		public TC57CIM.IEC61970.Base.Domain.Float x2InitialView;
		/// <summary>
		/// Y coordinate of the first corner of the initial view.
		/// </summary>
		public TC57CIM.IEC61970.Base.Domain.Float y1InitialView;
		/// <summary>
		/// Y coordinate of the second corner of the initial view.
		/// </summary>
		public TC57CIM.IEC61970.Base.Domain.Float y2InitialView;
