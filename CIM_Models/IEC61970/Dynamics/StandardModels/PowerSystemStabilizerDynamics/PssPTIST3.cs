...
namespace TC57CIM.IEC61970.Dynamics.StandardModels.PowerSystemStabilizerDynamics {
	...
	public class PssPTIST3 : PowerSystemStabilizerDynamics {
		...
		/// </summary>
		public TC57CIM.IEC61970.Base.Domain.Boolean isw;
		/// <summary>
		...
		/// Typical value = 4.
		/// </summary>
		public TC57CIM.IEC61970.Base.Domain.Float nav;
		/// <summary>
		/// Number of counts at limit to active limit function (<i>NCL</i>) (> 0).
		/// </summary>
		public TC57CIM.IEC61970.Base.Domain.Float ncl;
		/// <summary>
		/// Number of counts until reset after limit function is triggered (<i>NCR</i>).
		/// </summary>
		public TC57CIM.IEC61970.Base.Domain.Float ncr;
		/// <summary>
		/// (<i>Pmin</i>).
		/// </summary>
