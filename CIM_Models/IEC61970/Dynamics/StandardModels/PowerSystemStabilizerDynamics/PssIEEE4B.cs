...
namespace TC57CIM.IEC61970.Dynamics.StandardModels.PowerSystemStabilizerDynamics {
	...
	public class PssIEEE4B : PowerSystemStabilizerDynamics {
		...
		/// </summary>
		public TC57CIM.IEC61970.Base.Domain.Float bwh1;
		/// <summary>
		/// Notch filter 2 (high-frequency band): three dB bandwidth
		/// (<i>B</i><i><sub>wi</sub></i>).
		/// </summary>
		public TC57CIM.IEC61970.Base.Domain.Float bwh2;
		/// <summary>
		/// Notch filter 1 (low-frequency band): three dB bandwidth
		/// (<i>B</i><i><sub>wi</sub></i>).
		/// </summary>
		public TC57CIM.IEC61970.Base.Domain.Float bwl1;
		/// <summary>
		/// Notch filter 2 (low-frequency band): three dB bandwidth
		/// (<i>B</i><i><sub>wi</sub></i>).
		/// </summary>
		public TC57CIM.IEC61970.Base.Domain.Float bwl2;
		/// <summary>
		...
		/// </summary>
		public TC57CIM.IEC61970.Base.Domain.Float omeganh1;
		/// <summary>
		/// Notch filter 2 (high-frequency band): filter frequency
		/// (<i>omega</i><i><sub>ni</sub></i>).
		/// </summary>
		public TC57CIM.IEC61970.Base.Domain.Float omeganh2;
		/// <summary>
		/// Notch filter 1 (low-frequency band): filter frequency
		/// (<i>omega</i><i><sub>ni</sub></i>).
		/// </summary>
		public TC57CIM.IEC61970.Base.Domain.Float omeganl1;
		/// <summary>
		/// Notch filter 2 (low-frequency band): filter frequency
		/// (<i>omega</i><i><sub>ni</sub></i>).
		/// </summary>
		public TC57CIM.IEC61970.Base.Domain.Float omeganl2;
		/// <summary>
