...
namespace TC57CIM.IEC61968.InfIEC61968.InfWork {
	...
	public class OneCallRequest : WorkDocument {
		...
		/// </summary>
		public TC57CIM.IEC61970.Base.Domain.Boolean explosivesUsed;
		/// <summary>
		/// True if work location has been marked, for example for a dig area.
		/// </summary>
		public TC57CIM.IEC61970.Base.Domain.Boolean markedIndicator;
		/// <summary>
		/// Instructions for marking a dig area, if applicable.
		/// </summary>
		public TC57CIM.IEC61970.Base.Domain.String markingInstruction;
