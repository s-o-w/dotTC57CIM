...
namespace TC57CIM.IEC61968.Customers {
	public class TroubleTicket : Document {
		...
		/// </summary>
		public TC57CIM.IEC61970.Base.Domain.DateTime dateTimeOfReport;
		/// <summary>
		...
		/// </summary>
		public TC57CIM.IEC61970.Base.Domain.String firstResponderStatus;
		/// <summary>
		/// Set to true if the outage report indicated that other neighbors are also out of
		/// power.
		/// </summary>
		public TC57CIM.IEC61970.Base.Domain.Boolean multiplePremises;
		/// <summary>
		...
		/// </summary>
		public TC57CIM.IEC61970.Base.Domain.DateTime resolvedDateTime;
		/// <summary>
		/// Trouble code (e.g., power down, flickering lights, partial power, etc).
		/// </summary>
		public TC57CIM.IEC61970.Base.Domain.String troubleCode;
		/// <summary>
