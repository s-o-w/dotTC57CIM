...
namespace TC57CIM.IEC61968.Work {
	...
	public class WorkTask : BaseWork {
		...
		/// </summary>
		public TC57CIM.IEC61970.Base.Domain.DateTime crewETA;
		/// <summary>
		/// Time and Date when the work task will be completed.
		/// </summary>
		public TC57CIM.IEC61970.Base.Domain.DateTime estimatedCompletionTime;
		/// <summary>
		/// Instructions for performing this task.
		/// </summary>
		public TC57CIM.IEC61970.Base.Domain.String instruction;
		/// <summary>
		...
		/// </summary>
		public TC57CIM.IEC61970.Base.Domain.String schedOverride;
		/// <summary>
		/// Date and time work task was started.
		/// </summary>
		public TC57CIM.IEC61970.Base.Domain.DateTime startedDateTime;
		/// <summary>
		/// Kind of work.
		/// </summary>
